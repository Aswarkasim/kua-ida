  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="form-group">
          ...
          <input type="text" placeholder="Nama Pendaftar">
        </div>
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        <a href="<?= base_url('home/nikah/daftar/dataPria'); ?>" class="btn btn-primary btn-xl">Selanjutnya <i class="fa fa-arrow-right"></i></a>
